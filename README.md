...
|---|---|---|
| [Vault Daily Triage](./daily-triage/) | Live | Pulls overnight HSW incidents from Vault GRC, runs AI analysis, and delivers a risk-ranked summary to the HSW team each morning via Microsoft Teams |
| [Worker Offboarding](./offboarding/) | Live | When HR submits a form, automatically locates the worker in Vault GRC by Employee Number and archives them, no manual steps required |
| [Worker Onboarding](./onboarding/) | Live | When HR submits a form, automatically creates a new worker profile in Vault GRC with the correct employee type and shift classification |
...
*Part of the broader CNZ HSW digital transformation. See [carlo-tuhakaraina](https://github.com/carlo-tuhakaraina) for more context.*
